...
| E243      | semantic       | staged-residence `via law(...)` reached expansion but its compartment-staging lowering is not yet implemented (Phase 1 parses `via`; later phases lower it)                                                                                                                                                                        |
| E244–E276 | semantic       | observation, balance, simulation-block validation                                                                                                                                                                                                                                                                                 |
