...
/// modal observation gap by `fit predict`'s forecast grid (gh#696), which
/// continues a stream's own reporting cadence past the data — the one notion
/// of "this series' typical spacing".
///
